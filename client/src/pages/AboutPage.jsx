    ...
    <div style={{ padding: '16px 0 48px' }}>
      ...
      <section style={{ marginBottom: '40px' }}>
        <div className="about-features-grid">
          ...
          <AnimatedContent distance={35} delay={0.2}>
            <div className="about-feature-card">
          ...
          <AnimatedContent distance={35} delay={0.3}>
            <div className="about-feature-card">
      ...
      <AnimatedContent distance={35} delay={0.15}>
        <section
          style={{
            background: '#ffffff',
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '24px', fontSize: '0.86rem', color: '#64748b' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span><strong>Phone:</strong> +91 94475 59333</span>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                ...
                <a
                  href="https://wa.me/919447559333?text=Hello%20Variathu%20Power%20Tools%20Kozhencherry,%20I%20would%20like%20to%20connect%20with%20your%20team."
                  target="_blank"
